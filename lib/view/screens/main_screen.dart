      ...
      return Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(icon: Icon(Icons.category),label: "Category",activeIcon: Icon(Icons.category,)),
            BottomNavigationBarItem(icon: Icon(Icons.favorite),label: "Favorite",activeIcon: Icon(Icons.favorite,)),
